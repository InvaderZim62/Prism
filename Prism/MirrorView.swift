...
class MirrorView: UIView, PathProvider {
    ...
    lazy var vertices = [CGPoint(x: (1 + MirrorConst.widthPercent) / 2 * bounds.width - 1, y: bounds.height - 1),
                         CGPoint(x: (1 - MirrorConst.widthPercent) / 2 * bounds.width + 1, y: bounds.height - 1),
                         CGPoint(x: (1 - MirrorConst.widthPercent) / 2 * bounds.width + 1, y: 1),
                         CGPoint(x: (1 + MirrorConst.widthPercent) / 2 * bounds.width - 1, y: 1)]
